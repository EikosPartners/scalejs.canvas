...
define('scalejs.canvas/text',[
    ...
    return function (canvasObj) {
        function text(opts) {
            ...
            this.wasStatic = opts.wasStatic || false;
        ...
        function calcBoundsDynamic() {
            ...
            if (this.static && !this.wasStatic) {
                ...
                this.wasStatic = true;
                this.calcBounds = calcBoundsStatic;
                this.render = renderStatic;
            }
        };
        function calcBoundsStatic() {
            ...
            if (!this.static && this.wasStatic) {
                ...
                this.calcBounds = calcBoundsDynamic;
                this.render = renderDynamic;
            }
        };

        text.calcBounds = calcBoundsDynamic;
        ...
        function renderStatic() {
            ...
            if (this.opacity > 0 && this.text.length > 0) {
                ...
                canvasObj.context.translate(this.left, this.top);   // Set center.
                this.angle && canvasObj.context.rotate(this.angle * Math.PI / 180);   // Rotate text around center.
                canvasObj.context.drawImage(this.context, this.offset.left, this.offset.top);   // Draw text at offset pos.
                canvasObj.context.restore();
            }
        };

        text.render = renderDynamic;
