    ...
    return function (canvasObj) {
        ...
        function calcBoundsDynamic() {
            ...
            if (this.static && !this.wasStatic) {
                ...
                this.wasStatic = true;
                this.prototype.calcBounds = calcBoundsStatic;
            }
        };
        function calcBoundsStatic() {
            ...
            if (!this.static && this.wasStatic) {
                ...
                this.prototype.calcBounds = calcBoundsDynamic;
            }
        };

        text.prototype.calcBounds = calcBoundsDynamic;
        ...
        text.prototype.render = renderDynamic;
