...
define('scalejs.canvas/text',[
    ...
    return function (canvasObj) {
        ...
        text.prototype.setText = function (text) {
            // Compile font:
            if (this.fontFamily && this.fontSize) {
                this.font = this.fontSize + "px " + (this.fontFamily.indexOf(" ") >= 0 ? "\""+this.fontFamily+"\"" : this.fontFamily);
            ...
            if (this.calcText !== this.text || (this.font && this.font !== this.calcFont) || (!this.font && canvasObj.curFont !== this.calcFont)) {
                this.font && canvasObj.context.save();
                ...
                this.font && canvasObj.context.restore();
                this.calcText = this.text;
                this.calcFont = this.font ? this.font : canvasObj.curFont;
            }
        };
