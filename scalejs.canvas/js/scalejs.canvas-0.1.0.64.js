    ...
    return function (canvasObj) {
        ...
        Selector.prototype.data = function (nodes, keyFunc) {
            ...
            for (var i = 0; i < this.objects.length; i++) {
                if (nodeTable[this.objects[i].data.id]) {
                    this.objects[i].data.data = nodeTable[this.objects[i].data.id].data;
                    nodeTable[this.objects[i].data.id] = undefined;
                } else {
                    this.exitObjects.push(this.objects[i]);
